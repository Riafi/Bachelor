...
plt.text(0.39, 0.57, '$100 \% $ free-free contribution @ 345GHz',color = 'dimgray', rotation_mode = 'default' , rotation = 45, horizontalalignment='left',verticalalignment='top', transform=ax.transAxes)
...
for i in range(0,len(id)):
    print("{:.0f}".format(id[i]), '&', "{:.4f}".format(RA[i]), '&',"{:.4f}".format(dec[i]), '&' , "{:.2f}".format(flux[i]) ,'$\pm$',  "{:.2f}".format(flux_err[i]), '&' ,"{:.2f}".format(flux345[i]) ,'$\pm$',  "{:.2f}".format(flux345_err[i]), '&' ,"{:.2f}".format(S_ff100[i]) ,'$\pm$',  "{:.2f}".format(err_S_ff100[i]), '&',"{:.2f}".format((S_dust*10**3)[i]) ,'$\pm$',  "{:.2f}".format((eS_dust*10**3)[i]), '&',"{:.1f}".format(10**3*(np.sqrt((bmaj_100/2)*(bmin_100/2)))[i]) ,'$\pm$' , "{:.1f}".format(10**3*(np.sqrt(((((bmin_100_err))/2 )**2*(((bmaj_100))/2 )**2 + (((bmaj_100_err))/2 )**2 * (((bmin_100))/2 )**2)/((((bmin_100))/2 )*(((bmaj_100))/2 ))))[i]),'&' ,"{:.1f}".format(10**3*(np.sqrt((bmaj_345/2)*(bmin_345/2)))[i]) ,'$\pm$' , "{:.1f}".format(10**3*(np.sqrt(((((bmin_345_err))/2 )**2*(((bmaj_345))/2 )**2 + (((bmaj_345_err))/2 )**2 * (((bmin_345))/2 )**2)/((((bmin_345))/2 )*(((bmaj_345))/2 ))))[i]), '\\\\' )
